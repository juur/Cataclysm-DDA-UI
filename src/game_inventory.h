...
/** Select devices to use for e-file storage */
drop_locations edevice_select( Character &who, item_location &used_edevice, bool browse,
                               bool auto_include_used_edevice, bool no_usable, efile_action action );
