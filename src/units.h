...
template<typename value_type>
inline constexpr quantity<value_type, ememory_in_bytes_tag> from_bytes(
    const value_type v )
{
    return quantity<value_type, ememory_in_bytes_tag>( v, ememory_in_bytes_tag{} );
}
template<typename value_type>
inline constexpr quantity<value_type, ememory_in_bytes_tag> from_kilobytes( const value_type v )
{
    return from_bytes<value_type>( v ) * 1000;
}
template<typename value_type>
inline constexpr quantity<value_type, ememory_in_bytes_tag> from_megabytes( const value_type v )
{
    return from_kilobytes<value_type>( v ) * 1000;
}
template<typename value_type>
inline constexpr quantity<value_type, ememory_in_bytes_tag> from_gigabytes( const value_type v )
{
    return from_megabytes<value_type>( v ) * 1000;
}
template<typename value_type>
inline constexpr quantity<value_type, ememory_in_bytes_tag> from_terabytes( const value_type v )
{
...
inline constexpr units::ememory operator""_B( const unsigned long long b )
{
    return units::from_bytes( b );
}
